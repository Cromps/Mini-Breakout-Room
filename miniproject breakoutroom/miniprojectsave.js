...
var picture2 = document.getElementById("picure2");
...
function doMouseDown(event){
    ...
    else if(progress == 3 || progress == 4 || progress== 5 || progress == 6 && inspect == 0){
        let display = "There doesn't seem to be much here";
        typewrite(t,display);
    }
    else if(inspect == 1){
        let display = "I don't think I have enough information. I should look around to find a code.";
        typewrite(t, display);
        inspect = 0;
        hideObjects(cupboard_icon, door_icon, window_icon, board_icon, clock_icon, bed_icon, safe_icon, false);
    }
...
function safeBox(){
    ...
    else if(progress == 8 || progress == 9 && tools !== 5){
